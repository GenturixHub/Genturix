...
@api_router.patch("/casos/{caso_id}")
...
@api_router.post("/casos/{caso_id}/comments")
...
@api_router.post("/casos/{caso_id}/attachments")
@limiter.limit(RATE_LIMIT_PUSH)
...
@api_router.patch("/casos/{caso_id}/guard-update")
...
@api_router.get("/asamblea/{assembly_id}")
...
@api_router.post("/asamblea/{assembly_id}/agenda")
...
@api_router.post("/asamblea/{assembly_id}/attend")
...
@api_router.post("/asamblea/{assembly_id}/vote")
async def cast_vote(
    assembly_id: str,
    payload: VoteCreate,
    request: Request,
...
@api_router.get("/asamblea/{assembly_id}/results")
...
@api_router.post("/asamblea/{assembly_id}/generate-acta")
...
@api_router.patch("/asamblea/{assembly_id}")
...
@api_router.get("/notifications/v2")
...
@api_router.get("/notifications/v2/unread-count")
...
@api_router.post("/notifications/v2/broadcast")
...
@api_router.patch("/notifications/v2/read/{notification_id}")
...
@api_router.patch("/notifications/v2/read-all")
...
@api_router.get("/notifications/v2/broadcasts")
...
@api_router.get("/notifications/v2/preferences")
...
@api_router.patch("/notifications/v2/preferences")
